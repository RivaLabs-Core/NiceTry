object "ForsTreeShapeKernel" {
    code {
        if callvalue() {
            revert(0, 0)
        }
        function internal_internal_forsBase() -> __ret0 {
            __ret0 := shl(128, 3)
            leave
        }
        ...
        function internal_internal_nodeHash(pkSeed, tree, height, treeScale, parentIdx, left, right) -> __ret0 {
            ...
            __ret0 := add(add(pkSeed, adrs), add(mul(left, 131), mul(right, 257)))
            leave
        }
            ...
            }
            {
                ...
                if __has_selector {
                    ...
                    case 0xc43fc109 {
                        ...
                        let adrs := internal_internal_leafAdrs(tree, leafIdx)
                        mstore(0, add(add(pkSeed, adrs), sk))
                        return(0, 32)
                    }
                    case 0x7b0fcb8b {
                        /* nodeHash() */
                        ...
                        let adrs := internal_internal_nodeAdrs(tree, height, treeScale, parentIdx)
                        mstore(0, add(add(pkSeed, adrs), add(mul(left, 131), mul(right, 257))))
                        return(0, 32)
                    }
                    case 0x6fb382a7 {
                        /* climbLevel() */
